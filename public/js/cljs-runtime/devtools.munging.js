...
var temp__5751__auto____$1 = (o27049["core"]);
...
var o__26555__auto__ = f;
return (o__26555__auto__["toString"]).call(o__26555__auto__);
} else {
return "";
}
}catch (e27056){var _ = e27056;
return "";
}});
...
try{var o__26555__auto___27387 = t;
(o__26555__auto___27387["cljs$lang$ctorPrWriter"]).call(o__26555__auto___27387,t,writer);
}catch (e27067){var __27388 = e27067;
}
...
var char_code = (function (){var o__26555__auto__ = (new String(char$));
return (o__26555__auto__["charCodeAt"]).call(o__26555__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26555__auto__ = String;
return (o__26555__auto__["fromCharCode"]).call(o__26555__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27085 = num_code;
switch (G__27085) {
case (1):
return (185);
...
var o__26555__auto__ = String;
return (o__26555__auto__["fromCharCode"]).call(o__26555__auto__,superscript_code);
});
/**
...
}catch (e27110){var _e__26597__auto__ = e27110;
return false;
}})())){
...
var vec__27114 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27114,(0),null);
...
var len__4864__auto___27403 = arguments.length;
var i__4865__auto___27404 = (0);
while(true){
if((i__4865__auto___27404 < len__4864__auto___27403)){
args__4870__auto__.push((arguments[i__4865__auto___27404]));

var G__27406 = (i__4865__auto___27404 + (1));
i__4865__auto___27404 = G__27406;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27174){
var vec__27175 = p__27174;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27175,(0),null);
...
var G__27412 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__27413 = cljs.core.butlast(remaining_tokens);
name_tokens = G__27412;
remaining_tokens = G__27413;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27151){
var G__27152 = cljs.core.first(seq27151);
var seq27151__$1 = cljs.core.next(seq27151);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27152,seq27151__$1);
}));
...
var vec__27211 = cljs.core.split_with((function (p1__27209_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__27209_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27211,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27211,(1),null);
...
var vec__27226 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27226,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27226,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__27419 = cljs.core.rest(remaining_tokens);
var G__27420 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__27419;
name_tokens = G__27420;
continue;
} else {
...
var vec__27237 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27237,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27237,(1),null);
var vec__27240 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27240,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27240,(1),null);
var vec__27243 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27243,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27243,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27243,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27243,(3),null);
...
var vec__27258 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27258,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27258,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27258,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27258,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27258,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27258,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__27264 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27264,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27264,(1),null);
var vec__27270 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27270,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27270,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__27275 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__27275) : devtools.munging.parse_fn_info_deep.call(null,G__27275));
})()));
}
} else {
return fn_info;
...
var G__27430 = (arity + (1));
var G__27431 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27289){
var vec__27290 = p__27289;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27290,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27290,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27302_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__27302_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27304_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__27304_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27311){
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27307){
var G__27308 = cljs.core.first(seq27307);
var seq27307__$1 = cljs.core.next(seq27307);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27308,seq27307__$1);
}));
...
var map__27334 = options;
var map__27334__$1 = cljs.core.__destructure_map(map__27334);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27334__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27334__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27334__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27334__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27335 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27335,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27335,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27335,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27335,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27335,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27335,(5),null);
...
var o__26555__auto__ = f;
return (o__26555__auto__["getBasis"]).call(o__26555__auto__);
});
/**
...
}catch (e27344){var _e__26597__auto__ = e27344;
...
var G__27443 = (obj[cljs.core.first(path)]);
var G__27444 = cljs.core.rest(path);
obj = G__27443;
path = G__27444;
continue;
} else {
...
var _STAR_ = (function (accum,p__27364){
var vec__27365 = p__27364;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27365,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27365,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27371){
var vec__27372 = p__27371;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27372,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27372,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27372,(2),null);
...
var post_process = (function (p__27379){
var vec__27381 = p__27379;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27381,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27381,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27376_SHARP_){
return (obj[cljs.core.first(p1__27376_SHARP_)]);
}),sorted_matches);
