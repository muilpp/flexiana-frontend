...
var len__4864__auto___27521 = arguments.length;
var i__4865__auto___27522 = (0);
while(true){
if((i__4865__auto___27522 < len__4864__auto___27521)){
args__4870__auto__.push((arguments[i__4865__auto___27522]));

var G__27523 = (i__4865__auto___27522 + (1));
i__4865__auto___27522 = G__27523;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq27449){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27450,G__27451,seq27449__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__27472_SHARP_){
return (!((cljs.core.meta(p1__27472_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27492__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e27494){var _e__26597__auto__ = e27494;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e27497){var _e__26597__auto__ = e27497;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__27508 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__27509 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__27509);

try{var map__27510 = opts;
var map__27510__$1 = cljs.core.__destructure_map(map__27510);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27510__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__27508);
}});
...
var temp__5751__auto___27548 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___27548)){
var managed_print_level_27549 = temp__5751__auto___27548;
var _STAR_print_level_STAR__orig_val__27512_27550 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__27513_27551 = managed_print_level_27549;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__27513_27551);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__27511_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__27511_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__27512_27550);
}} else {
job_fn();
}
