...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_32145 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_32145(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_32158 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_32158(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_32163 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_32163(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_32164 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_32164(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_32168 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_32168(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_32170 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_32170(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__32140,callback){
var map__32141 = p__32140;
var map__32141__$1 = cljs.core.__destructure_map(map__32141);
var input = map__32141__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32141__$1,new cljs.core.Keyword(null,"code","code",1586293142));
