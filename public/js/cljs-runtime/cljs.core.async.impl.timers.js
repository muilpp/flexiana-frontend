...
var i_32442 = (0);
while(true){
if((i_32442 < arr.length)){
(arr[i_32442] = null);

var G__32444 = (i_32442 + (1));
i_32442 = G__32444;
continue;
} else {
}
...
var i_32485 = (self__.level + (1));
while(true){
if((i_32485 <= (new_level + (1)))){
(update[i_32485] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_32492 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_32492[i]));
} else {
x__$2.forward.push((((i < links_32492.length))?(links_32492[i]):null));
}

if((i < links_32492.length)){
(links_32492[i] = x__$2);
} else {
links_32492.push(x__$2);
}
...
var i_32495 = (0);
while(true){
if((i_32495 <= self__.level)){
var links_32496 = (update[i_32495]).forward;
if((x__$1 === (((i_32495 < links_32496.length))?(links_32496[i_32495]):null))){
(links_32496[i_32495] = (x__$1.forward[i_32495]));

var G__32497 = (i_32495 + (1));
i_32495 = G__32497;
continue;
} else {
var G__32498 = (i_32495 + (1));
i_32495 = G__32498;
continue;
}
} else {
...
var G__32500 = nx;
var G__32501 = (level__$1 - (1));
x = G__32500;
level__$1 = G__32501;
continue;
} else {
var G__32502 = x;
var G__32503 = (level__$1 - (1));
x = G__32502;
level__$1 = G__32503;
continue;
}
