...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_30063 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_30063(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_30065 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_30065(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_30073 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_30073(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_30082 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_30082(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_30097 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_30097(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_30103 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_30103(reader);
}
});
