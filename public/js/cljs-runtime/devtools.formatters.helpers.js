...
var G__27441 = devtools.prefs.pref(v);
v = G__27441;
continue;
} else {
return v;
...
}catch (e27401){var _e__26597__auto__ = e27401;
return false;
}})();
...
}catch (e27405){var _e__26597__auto__ = e27405;
return false;
}})();
...
}catch (e27409){var _e__26597__auto__ = e27409;
return false;
}}
}
});
...
var vec__27426 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27426,(0),null);
...
return cljs.core.some((function (p1__27429_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27429_SHARP_);
}),template);
});
