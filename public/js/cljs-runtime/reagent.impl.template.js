...
var G__37355 = o;
reagent.impl.template.goog$module$goog$object.set(G__37355,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__37489__i < G__37489__a.length) {G__37489__a[G__37489__i] = arguments[G__37489__i + 0]; ++G__37489__i;}
  args = new cljs.core.IndexedSeq(G__37489__a,0,null);
} 
return G__37487__delegate.call(this,args);};
G__37487.cljs$lang$maxFixedArity = 0;
G__37487.cljs$lang$applyTo = (function (arglist__37491){
...
var G__37358 = o;
reagent.impl.template.goog$module$goog$object.set(G__37358,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__37496__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__37497__i < G__37497__a.length) {G__37497__a[G__37497__i] = arguments[G__37497__i + 0]; ++G__37497__i;}
  args = new cljs.core.IndexedSeq(G__37497__a,0,null);
} 
return G__37496__delegate.call(this,args);};
G__37496.cljs$lang$maxFixedArity = 0;
G__37496.cljs$lang$applyTo = (function (arglist__37498){
var args = cljs.core.seq(arglist__37498);
return G__37496__delegate(args);
});
...
var G__37362 = props;
var G__37362__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37362,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37362);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37362__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__37363 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37363,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__37363;
}
})(),id_class);
...
var G__37364 = (cljs.core.count(argv) - first_child);
switch (G__37364) {
case (0):
...
var vec__37367 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37367,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37367,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37367,(2),null);
...
var temp__5757__auto___37518 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___37518 == null)){
} else {
var key_37520 = temp__5757__auto___37518;
(jsprops.key = key_37520);
}
...
var temp__5757__auto___37526 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___37526 == null)){
} else {
var key_37528 = temp__5757__auto___37526;
(jsprops.key = key_37528);
}
...
var temp__5757__auto___37530 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___37530 == null)){
} else {
var key_37531 = temp__5757__auto___37530;
(jsprops.key = key_37531);
}
...
var temp__5757__auto___37549 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___37549 == null)){
} else {
var key_37550 = temp__5757__auto___37549;
(jsprops.key = key_37550);
}
...
var temp__5757__auto___37554 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___37554 == null)){
} else {
var key_37555 = temp__5757__auto___37554;
(jsprops.key = key_37555);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37418_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__37418_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__37421 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37421,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37421,(1),null);
...
break;
default:
var G__37563 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__37564 = compiler;
v = G__37563;
compiler = G__37564;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template37465 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template37465 = (function (opts,id,fn_to_element,parse_fn,meta37466){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template37465.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_37467,meta37466__$1){
var self__ = this;
var _37467__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template37465(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta37466__$1));
}));

(reagent.impl.template.t_reagent$impl$template37465.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_37467){
var self__ = this;
var _37467__$1 = this;
return self__.meta37466;
}));

(reagent.impl.template.t_reagent$impl$template37465.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template37465.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template37465.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template37465.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template37465.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template37465.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta37466","meta37466",322368084,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template37465.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template37465.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template37465");

(reagent.impl.template.t_reagent$impl$template37465.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template37465");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template37465.
 */
reagent.impl.template.__GT_t_reagent$impl$template37465 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template37465(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta37466){
return (new reagent.impl.template.t_reagent$impl$template37465(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta37466));
});

}

return (new reagent.impl.template.t_reagent$impl$template37465(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
