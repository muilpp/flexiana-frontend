...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36989 = c;
var G__36989__$1 = (((G__36989 == null))?null:G__36989.prototype);
if((G__36989__$1 == null)){
return null;
} else {
return G__36989__$1.reagentRender;
}
})() == null)))));
});
...
while (G__37323__i < G__37323__a.length) {G__37323__a[G__37323__i] = arguments[G__37323__i + 0]; ++G__37323__i;}
  args = new cljs.core.IndexedSeq(G__37323__a,0,null);
} 
return G__37321__delegate.call(this,args);};
G__37321.cljs$lang$maxFixedArity = 0;
G__37321.cljs$lang$applyTo = (function (arglist__37324){
var args = cljs.core.seq(arglist__37324);
...
var or__4253__auto__ = (function (){var G__37043 = c;
var G__37043__$1 = (((G__37043 == null))?null:G__37043.constructor);
if((G__37043__$1 == null)){
return null;
} else {
return G__37043__$1.displayName;
}
})();
...
var G__37044 = c;
var G__37044__$1 = (((G__37044 == null))?null:G__37044.constructor);
if((G__37044__$1 == null)){
return null;
} else {
return G__37044__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__37050 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__37051 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__37051);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__37050);
}});
...
var c = this;
var G__37143_37332 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__37143_37332 == null)){
} else {
reagent.ratom.dispose_BANG_(G__37143_37332);
}
...
var renders_37333 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_37334 = cljs.core.first(cljs.core.vals(renders_37333));
...
if((cljs.core.count(renders_37333) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_37333))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_37334)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_37334], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__37236 = o;
reagent.impl.component.goog$module$goog$object.set(G__37236,cljs.core.name(k),v);
...
while (G__37341__i < G__37341__a.length) {G__37341__a[G__37341__i] = arguments[G__37341__i + 0]; ++G__37341__i;}
  args = new cljs.core.IndexedSeq(G__37341__a,0,null);
} 
return G__37339__delegate.call(this,args);};
G__37339.cljs$lang$maxFixedArity = 0;
G__37339.cljs$lang$applyTo = (function (arglist__37342){
...
var _STAR_current_component_STAR__orig_val__37306 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__37307 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__37307);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__37306);
}});
...
var G__37314 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__37314 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__37314);
}
});
}),[]);
